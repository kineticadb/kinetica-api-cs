...
public class UploadFilesFromurlRequest : KineticaData
{
    ...
    /// cref="UploadFilesFromurlRequest.file_names" />.</summary>
    ...
    /// <summary>Constructs an UploadFilesFromurlRequest object with default
    /// parameters.</summary>
    ...
    /// characters.</param>
    /// <param name="urls">List of URLs to upload, for each respective file in
    /// <paramref name="file_names" />.</param>
...
{
    /// <summary>List of <see
    /// cref="UploadFilesFromurlRequest.file_names">file_names</see> that were
    /// successfully uploaded.</summary>
    public IList<string> successful_file_names { get; set; } = new List<string>();

    /// <summary>List of <see cref="UploadFilesFromurlRequest.urls">urls</see>
    /// that were successfully uploaded.</summary>
