...
namespace kinetica
{
    ...
    /// cref="Kinetica.uploadFilesFromurl(IList{string},IList{string},IDictionary{string, string})"
    /// />.
    /// <br />
    ...
    public class UploadFilesFromurlRequest : KineticaData
    {
        ...
        /// <summary>List of URLs to upload, for each respective file in
        /// <paramref cref="UploadFilesFromurlRequest.file_names" />.
        /// </summary>
    ...
    public class UploadFilesFromurlResponse : KineticaData
    {
        ...
        /// <summary>List of <paramref
        /// cref="UploadFilesFromurlRequest.file_names" /> that were
        /// successfully uploaded.  </summary>
        public IList<string> successful_file_names { get; set; } = new List<string>();

        /// <summary>List of <paramref cref="UploadFilesFromurlRequest.urls" />
