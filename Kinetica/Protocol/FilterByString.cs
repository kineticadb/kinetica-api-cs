...
public class FilterByStringRequest : KineticaData
{
    ...
    /// <summary>Constructs a FilterByStringRequest object with the specified
    /// parameters.</summary>
    ///
    ...
    /// <param name="expression">The expression with which to filter the table.
    /// </param>
    /// <param name="mode">The string filtering mode to apply. See below for
    /// details.
    /// Supported values:
    /// <list type="bullet">
    ///     <item>
...
public class FilterByStringResponse : KineticaData
{
    ...
    /// <summary>The number of records that passed the string filter.</summary>
