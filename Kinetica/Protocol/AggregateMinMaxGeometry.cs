...
public class AggregateMinMaxGeometryRequest : KineticaData
{
    ...
    /// <summary>Name of a geospatial geometry column on which the min-max will
    ...
    /// <summary>Constructs an AggregateMinMaxGeometryRequest object with the
    ...
    /// <param name="column_name">Name of a geospatial geometry column on which
    /// the min-max will be calculated.</param>
