...
namespace kinetica
{
    ...
    /// filter specification is also created if a <see cref="view_name" /> is
    /// passed in as part of the request.</para>
    /// <para>For example, if a type definition has the columns 'x' and 'y',
    /// then a filter by list query with the column map {"x":["10.1", "2.3"],
    ...
    public class FilterByListRequest : KineticaData
    {
        ...
        ///         <list type="bullet">
        ///             <item>
        ///                 <term><see cref="Options.IN_LIST">IN_LIST</see>:
        ///                 </term>
        ...
        ///             <item>
        ///                 <term><see
        ///                 cref="Options.NOT_IN_LIST">NOT_IN_LIST</see>:
        ///                 </term>
        ///                 <description>The filter will match all items that
        ...
        ///         cref="Options.IN_LIST">IN_LIST</see>.</description>
        ///     </item>
        /// </list>
