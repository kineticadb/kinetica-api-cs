...
/// values match both in the respective x- and y-lists, e.g., "x = 10.1 and y =
/// 0.0", "x = 2.3 and y = -31.5", etc. However, a record with "x = 10.1 and y
/// = -31.5" or "x = 2.3 and y = 0.0" would not be returned because the values
/// in the given lists do not correspond.</para></remarks>
public class FilterByListRequest : KineticaData
{
    ...
    public struct Options
    {
        ...
        /// cref="FilterByListRequest.Options" /> options.</summary>
