...
public class GrantPermissionTableRequest : KineticaData
{
    ...
    {
        /// <summary>Full read/write and administrative access to the table.
        /// </summary>
    ...
    /// <summary>Name of the table to which the permission grants access, in
    /// [schema_name.]table_name format, using standard <a
    /// href="../../../concepts/tables/#table-name-resolution"
    /// target="_top">name resolution rules</a>.</summary>
    /// <remarks><para> Must be an existing table, view, or schema. If a
    /// schema, the permission also applies to tables and views in the schema.
    /// </para></remarks>
    public string table_name { get; set; }

    /// <summary>Optional filter expression to apply to this grant.</summary>
    /// <remarks><para> Only rows that match the filter will be affected. The
    ...
    /// <summary>Constructs a GrantPermissionTableRequest object with default
    /// parameters.</summary>
    ...
    /// grants access, in [schema_name.]table_name format, using standard <a
    /// href="../../../concepts/tables/#table-name-resolution"
    /// target="_top">name resolution rules</a>.  Must be an existing table,
    /// view, or schema. If a schema, the permission also applies to tables and
    /// views in the schema.</param>
    /// <param name="filter_expression">Optional filter expression to apply to
    /// this grant.  Only rows that match the filter will be affected. The
