...
public class AdminAddHostRequest : KineticaData
{
    ...
    public struct Options
    {
        ...
        /// added, typically specified for clients using multi-head operations.
        /// </summary>
        /// <remarks><para>This setting is required if any other host(s) in the
        /// cluster specify a public address.</para></remarks>
        public const string PUBLIC_ADDRESS = "public_address";

        /// <summary>The publicly-accessible full path URL to the host manager
        /// on the host being added, e.g., 'http://172.123.45.67:9300'.
        /// </summary>
        /// <remarks><para>The default host manager port can be found in the <a
        /// href="../../../install/shared/ports/" target="_top">list of
        /// ports</a> used by Kinetica.</para></remarks>
        public const string HOST_MANAGER_PUBLIC_URL = "host_manager_public_url";

        /// <summary>The desired RAM limit for the host being added, i.e. the
        /// sum of RAM usage for all processes on the host will not be able to
        ...
        /// are eligible for running worker processes.</summary>
        /// <remarks><para>If left blank, all GPUs on the host being added will
        /// be eligible.</para></remarks>
    ...
    /// Kinetica as the cluster to which it is being added.</para></remarks>
    ...
    ///         the cluster specify a public address.</description>
    ///     </item>
    ///     <item>
    ///         <term><see
    ...
    /// <summary>Constructs an AdminAddHostRequest object with the specified
    /// parameters.</summary>
    ///
    /// <param name="host_address">IP address of the host that will be added to
    /// the cluster. This host must have installed the same version of Kinetica
    /// as the cluster to which it is being added.</param>
...
public class AdminAddHostResponse : KineticaData
{
    ...
    /// <remarks><para>Note that the host identifier is transient, i.e. it may
    /// change in the future if other hosts are removed.</para></remarks>
