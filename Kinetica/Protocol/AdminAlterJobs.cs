...
/// actions for each specified job is returned in the status array of the
/// response. See <a href="../../../admin/job_manager/" target="_top">Job
...
public class AdminAlterJobsRequest : KineticaData
{
    ...
    /// <summary>Constructs an AdminAlterJobsRequest object with the specified
    /// parameters.</summary>
    ///
    /// <param name="job_ids">Jobs to be modified.</param>
    /// <param name="action">Action to be performed on the jobs specified by
    /// job_ids.
    /// Supported values:
    /// <list type="bullet">
    ///     <item>
