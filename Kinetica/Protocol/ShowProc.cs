...
public class ShowProcRequest : KineticaData
{
    ...
    /// <remarks><para>If specified, must be the name of a currently existing
    /// proc. If not specified, information about all procs will be returned.
    ...
    /// <summary>Constructs a ShowProcRequest object with default parameters.
    /// </summary>
    ...
    /// parameters.</summary>
    ///
    /// <param name="proc_name">Name of the proc to show information about. If
    /// specified, must be the name of a currently existing proc. If not
    /// specified, information about all procs will be returned. The default
    /// value is ''.</param>
