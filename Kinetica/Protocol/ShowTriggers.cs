...
public class ShowTriggersRequest : KineticaData
{
    ...
    /// retrieved.</summary>
    /// <remarks><para>An empty list means information will be retrieved on all
    /// active triggers.</para></remarks>
    ...
    /// parameters.</summary>
    ///
    /// <param name="trigger_ids">List of IDs of the triggers whose information
    /// is to be retrieved. An empty list means information will be retrieved
...
public class ShowTriggersResponse : KineticaData
{
    ...
    /// (key, value) pairs where the keys consist of 'table_name', 'type' and
    /// the parameter names relating to the trigger type, e.g. *nai*, *min*,
    /// *max*. The values are unicode strings (numeric values are also
    /// converted to strings) representing the value of the respective
    /// parameter. If a trigger is associated with multiple tables, then the
    /// string value for *table_name* contains a comma separated list of table
    /// names.</para></remarks>
