...
namespace kinetica
{
    ...
    /// </summary>
    /// <remarks><para>Retrieves information regarding the specified triggers
    /// or all existing triggers currently active.</para></remarks>
    public class ShowTriggersRequest : KineticaData
    {
        /// <summary>List of IDs of the triggers whose information is to be
        /// retrieved.</summary>
        /// <remarks><para>An empty list means information will be retrieved on
        /// all active triggers.</para></remarks>
    ...
    public class ShowTriggersResponse : KineticaData
    {
        ...
        /// representing a Trigger ID.</summary>
        /// <remarks><para>The value is another embedded dictionary containing
        /// (key, value) pairs where the keys consist of 'table_name', 'type'
        /// and the parameter names relating to the trigger type, e.g. *nai*,
        /// *min*, *max*. The values are unicode strings (numeric values are
        /// also converted to strings) representing the value of the respective
        /// parameter. If a trigger is associated with multiple tables, then
        /// the string value for *table_name* contains a comma separated list
        /// of table names.</para></remarks>
