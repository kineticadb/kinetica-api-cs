...
public class AggregateHistogramRequest : KineticaData
{
    ...
    public struct Options
    {
        ...
        /// <remarks><para> The column must be a numerical type (int, double,
        /// long, float).</para></remarks>
        public const string VALUE_COLUMN = "value_column";

        /// <summary>The start parameter for char types.</summary>
        public const string START = "start";

        /// <summary>The end parameter for char types.</summary>
        public const string END = "end";

        /// <summary>The interval parameter for char types.</summary>
    ...
    /// <summary>Name of a column or an expression of one or more column names
    /// over which the histogram will be calculated.</summary>
    ...
    /// <summary>Constructs an AggregateHistogramRequest object with default
    /// parameters.</summary>
    ...
    /// more column names over which the histogram will be calculated.</param>
    /// <param name="start">Lower end value of the histogram interval,
    /// inclusive.</param>
    /// <param name="end">Upper end value of the histogram interval, inclusive.
    /// </param>
    /// <param name="interval">The size of each bin within the start and end
    /// parameters.</param>
...
{
    /// <summary>The array of calculated values that represents the histogram
    /// data points.</summary>
    ...
    /// <summary>Value of <see cref="AggregateHistogramRequest.end">end</see>.
    /// </summary>
    public double end { get; set; }
