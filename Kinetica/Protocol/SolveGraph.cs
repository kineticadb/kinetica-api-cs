...
/// target="_top">/solve/graph examples</a> before using this endpoint.</para>
/// </remarks>
public class SolveGraphRequest : KineticaData
{
    ...
    {
        /// <summary>Solves for the optimal (shortest) path based on weights
        /// and restrictions from one source to destinations nodes.</summary>
        /// <remarks><para>Also known as the Dijkstra solver.</para></remarks>
        public const string SHORTEST_PATH = "SHORTEST_PATH";

        /// <summary>Solves for the probability of each destination node being
        /// visited based on the links of the graph topology.</summary>
        /// <remarks><para>Weights are not required to use this solver.</para>
        /// </remarks>
        public const string PAGE_RANK = "PAGE_RANK";

        /// <summary>Solves for the transitional probability (Hidden Markov)
        /// for each node based on the weights (probability assigned over given
        /// edges).</summary>
        public const string PROBABILITY_RANK = "PROBABILITY_RANK";

        /// <summary>Solves for the degree of a node to depict how many pairs
        /// of individuals that would have to go through the node to reach one
        /// another in the minimum number of hops.</summary>
        /// <remarks><para>Also known as betweenness.</para></remarks>
        public const string CENTRALITY = "CENTRALITY";

        /// <summary>Solves for finding the minimum cost cumulative path for a
        /// round-trip starting from the given source and visiting each given
        /// destination node once then returning to the source.</summary>
        /// <remarks><para>Also known as the traveling salesman problem.</para>
        /// </remarks>
        public const string MULTIPLE_ROUTING = "MULTIPLE_ROUTING";

        /// <summary>Solves for finding the optimal path cost for each
        /// destination node to route to the source node.</summary>
        /// <remarks><para>Also known as inverse Dijkstra or the service man
        /// routing problem.</para></remarks>
        public const string INVERSE_SHORTEST_PATH = "INVERSE_SHORTEST_PATH";

        /// <summary>Solves for optimal routes that connect remote asset nodes
        /// to the fixed (backbone) asset nodes.</summary>
        public const string BACKHAUL_ROUTING = "BACKHAUL_ROUTING";

        /// <summary>Solves for paths that would give costs between max and min
        /// solution radia - Make sure to limit by the 'max_solution_targets'
        /// option.</summary>
        /// <remarks><para>Min cost should be &gt;= shortest_path cost.</para>
        /// </remarks>
        public const string ALLPATHS = "ALLPATHS";

        /// <summary>Solves for graph statistics such as graph diameter,
        /// longest pairs, vertex valences, topology numbers, average and max
        /// cluster sizes, etc.</summary>
        public const string STATS_ALL = "STATS_ALL";

        /// <summary>Solves for the centrality closeness score per node as the
        /// sum of the inverse shortest path costs to all nodes in the graph.
        /// </summary>
    ...
    public struct Options
    {
        ...
        /// solver. The default value is '0'.</para></remarks>
        ...
        /// <summary>If true then concatenated edge IDs will be added as the
        /// EDGE path column of the solution table for each source and target
        /// pair in shortest path solves.</summary>
        ...
        /// as the Wktroute column of the solution table for each source and
        ...
        /// amongst the server containing the corresponding graph.</para>
        /// </remarks>
        ...
        /// convergence.</summary>
        /// <remarks><para>Default value is 1 (one) percent. The default value
        /// is '1.0'.</para></remarks>
        ...
        /// </summary>
        /// <remarks><para>Default value of 0 enables this value to be auto
        ...
        /// and shortest path solves towards a single target.</summary>
        /// <remarks><para>Supported values:</para>
        /// <list type="bullet">
        ///     <item>
        ...
        /// 'astar'.</summary>
        /// <remarks><para>The shortest path traversal front includes nodes
        /// only within this radius (kilometers) as it moves towards the target
        /// location. The default value is '70'.</para></remarks>
    ...
    /// be added (in the case of 'WEIGHTS_VALUESPECIFIED') to or multiplied
    /// with (in the case of 'WEIGHTS_FACTORSPECIFIED') the existing weight(s).
    /// If using constant values in an identifier combination, the number of
    /// values specified must match across the combination. The default value
    /// is an empty List.</para></remarks>
    ...
    /// expressions, e.g., 'column/2 AS RESTRICTIONS_VALUECOMPARED', or
    /// constant values, e.g., '{0, 0, 0, 1} AS RESTRICTIONS_ONOFFCOMPARED'. If
    /// using constant values in an identifier combination, the number of
    /// values specified must match across the combination. If
    /// remove_previous_restrictions option is set to true, any provided
    /// restrictions will replace the existing restrictions. Otherwise, any
    ...
    /// <summary>The type of solver to use for the graph.</summary>
    /// <remarks><para>Supported values:</para>
    /// <list type="bullet">
    ///     <item>
    ...
    ///         visiting each given destination node once then returning to the
    ///         source. Also known as the traveling salesman problem.
    ///         </description>
    ///     </item>
    ///     <item>
    ///         <term><see
    ...
    ///         inverse Dijkstra or the service man routing problem.
    ///         </description>
    ///     </item>
    ///     <item>
    ///         <term><see
    ...
    /// <remarks><para>The default value is 'graph_solutions'.</para></remarks>
    ...
    ///         solver. The user may want to override this parameter to
    ///         speed-up the solver. The default value is '0'.</description>
    ///     </item>
    ///     <item>
    ///         <term><see
    ...
    ///         to a lesser value, it can potentially speed up the solver. The
    ///         default value is '2000000'.</description>
    ///     </item>
    ///     <item>
    ///         <term><see
    ...
    ///         input is split amongst the server containing the corresponding
    ///         graph.</description>
    ///     </item>
    ///     <item>
    ///         <term><see
    ...
    ///         the target location. The default value is '70'.</description>
    ///     </item>
    /// </list>
    /// <para>The default value is an empty Dictionary.</para></remarks>
    public IDictionary<string, string> options { get; set; } = new Dictionary<string, string>();

    /// <summary>Constructs a SolveGraphRequest object with default parameters.
    /// </summary>
    ...
    /// parameters.</summary>
    ///
    /// <param name="graph_name">Name of the graph resource to solve.</param>
...
public class SolveGraphResponse : KineticaData
{
    ...
    /// <summary>Cost or page rank (based on solver type) for each destination
    /// node requested.</summary>
    /// <remarks><para>Only populated if 'export_solve_results' option is set
