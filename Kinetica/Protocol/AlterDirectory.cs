...
public class AlterDirectoryRequest : KineticaData
{
    ...
    {
        /// <summary>The maximum capacity, in bytes, to apply to the directory.
        /// </summary>
    ...
    /// <summary>Constructs an AlterDirectoryRequest object with the specified
    /// parameters.</summary>
    ///
    /// <param name="directory_name">Name of the directory in KiFS to be
    /// altered.</param>
    /// <param name="directory_updates_map">Map containing the properties of
    /// the directory to be altered. Error if empty.
    /// <list type="bullet">
    ///     <item>
    ///         <term><see
    ///         cref="AlterDirectoryRequest.DirectoryUpdatesMap.DATA_LIMIT">DATA_LIMIT</see>:
