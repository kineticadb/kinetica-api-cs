...
public class AlterDatasourceRequest : KineticaData
{
    ...
    ///         'jdbc', 'kafka', 'confluent', and 's3'.</description>
    ///     </item>
    ///     <item>
    ///         <term><see
    ...
    /// <summary>Constructs an AlterDatasourceRequest object with the specified
    /// parameters.</summary>
    ///
    /// <param name="name">Name of the data source to be altered. Must be an
    /// existing data source.</param>
    /// <param name="datasource_updates_map">Map containing the properties of
