...
public class FilterRequest : KineticaData
{
    ...
    /// <summary>The select expression to filter the specified table.</summary>
    /// <remarks><para> For details see <a
    ...
    /// <summary>Constructs a FilterRequest object with default parameters.
    /// </summary>
    ...
    /// <param name="expression">The select expression to filter the specified
    /// table.  For details see <a href="../../../concepts/expressions/"
