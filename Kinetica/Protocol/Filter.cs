...
namespace kinetica
{
    ...
    /// <remarks><para>Filters data based on the specified expression.  The
    /// results are stored in a <a href="../../../concepts/filtered_views/"
    ...
    public class FilterRequest : KineticaData
    {
        ...
        /// <summary>The select expression to filter the specified table.
        /// </summary>
