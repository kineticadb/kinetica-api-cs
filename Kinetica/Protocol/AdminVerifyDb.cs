...
public class AdminVerifyDbRequest : KineticaData
{
    ...
    /// <summary>Constructs an AdminVerifyDbRequest object with the specified
    /// parameters.</summary>
    ///
...
public class AdminVerifyDbResponse : KineticaData
{
    ...
    /// <summary>List of errors found while validating the database internal
    /// state.</summary>
    ...
    /// cref="AdminVerifyDbRequest.Options.DELETE_ORPHANED_TABLES">DELETE_ORPHANED_TABLES</see>
    /// is <see cref="AdminVerifyDbRequest.Options.TRUE">TRUE</see>, this is
    /// the sum in bytes of all orphaned tables found.</summary>
