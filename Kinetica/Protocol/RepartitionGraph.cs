...
public class RepartitionGraphRequest : KineticaData
{
    ...
    {
        /// <summary>If a non-empty value is specified, the original graph will
        /// be kept (non-default behavior) and a new balanced graph will be
        /// created under this given name.</summary>
        /// <remarks><para> When the value is empty (default), the generated
        /// 'balanced' graph will replace the original 'unbalanced' graph under
        /// the same graph name. The default value is ''.</para></remarks>
        ...
        /// partitions using the iso-distance levels of the solution.</summary>
        /// <remarks><para> The source node is selected by the rebalance
        /// algorithm automatically (default case when the value is an empty
        /// string). Otherwise, the user specified node is used as the source.
    ...
    ///         graph will be created under this given name.  When the value is
    ///         empty (default), the generated 'balanced' graph will replace
    ///         the original 'unbalanced' graph under the same graph name. The
    ...
    ///         the source. The default value is ''.</description>
    ///     </item>
    /// </list>
    ...
    /// <summary>Constructs a RepartitionGraphRequest object with the specified
    /// parameters.</summary>
    ///
