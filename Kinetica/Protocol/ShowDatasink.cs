...
public class ShowDatasinkRequest : KineticaData
{
    ...
    /// </summary>
    /// <remarks><para>The name must refer to a currently existing data sink.
    /// If '*' is specified, information about all data sinks will be returned.
    /// </para></remarks>
    ...
    /// information. The name must refer to a currently existing data sink. If
    /// '*' is specified, information about all data sinks will be returned.
    /// </param>
