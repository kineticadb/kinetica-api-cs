...
public class ShowSystemPropertiesRequest : KineticaData
{
    ...
    {
        /// <summary>A list of comma separated names of properties requested.
        /// </summary>
        /// <remarks><para>If not specified, all properties will be returned.
        /// </para></remarks>
    ...
    /// <summary>Constructs a ShowSystemPropertiesRequest object with default
    /// parameters.</summary>
...
public class ShowSystemPropertiesResponse : KineticaData
{
    ...
    {
        /// <summary>Boolean value indicating whether the system is configured
        /// for multi-head ingestion.</summary>
        ...
        /// <summary>Indicates that the system is NOT configured for multi-head
        /// ingestion.</summary>
        public const string FALSE = "FALSE";

        /// <summary>Semicolon (';') separated string of IP addresses of all
        /// the ingestion-enabled worker heads of the system.</summary>
        public const string CONF_WORKER_HTTP_SERVER_IPS = "conf.worker_http_server_ips";

        /// <summary>Semicolon (';') separated string of the port numbers of
        /// all the ingestion-enabled worker ranks of the system.</summary>
        public const string CONF_WORKER_HTTP_SERVER_PORTS = "conf.worker_http_server_ports";

        /// <summary>The host manager port number (an integer value).</summary>
        public const string CONF_HM_HTTP_PORT = "conf.hm_http_port";

        /// <summary>Flag indicating whether high availability (HA) is set up
        /// (a boolean value).</summary>
        public const string CONF_ENABLE_HA = "conf.enable_ha";

        /// <summary>A comma-separated string of high availability (HA) ring
        /// node URLs.</summary>
        /// <remarks><para> If HA is not set up, then an empty string.</para>
        /// </remarks>
