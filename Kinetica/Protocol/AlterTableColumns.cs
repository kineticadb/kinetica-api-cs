...
/// <para>Create or delete an <a href="../../../concepts/indexes/#column-index"
...
/// operators on indexed columns. This only applies to tables.</para>
...
public class AlterTableColumnsRequest : KineticaData
{
    ...
    /// <param name="column_alterations">List of alter table add/delete/change
    /// column requests - all for the same table. Each request is a map that
    /// includes 'column_name', 'action' and the options specific for the
