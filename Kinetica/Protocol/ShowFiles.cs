...
public class ShowFilesRequest : KineticaData
{
    ...
    /// <remarks><para>Each path can be a KiFS directory name, or a full path
    /// to a KiFS file. File paths may contain wildcard characters after the
    ...
    /// <summary>Constructs a ShowFilesRequest object with default parameters.
    /// </summary>
    ...
    /// directory name, or a full path to a KiFS file. File paths may contain
...
public class ShowFilesResponse : KineticaData
{
    ...
    /// cref="ShowFilesResponse.info" />.</summary>
    ...
    ///     <item>
    ///         <term><see
    ///         cref="ShowFilesResponse.Info.MULTIPART_UPLOADS">MULTIPART_UPLOADS</see>:
    ///         </term>
    ///         <description>JSON-encoded information about multipart uploads
