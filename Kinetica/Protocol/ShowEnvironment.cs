...
namespace kinetica
{
    ...
    /// cref="Kinetica.showEnvironment(string,IDictionary{string, string})"
    /// />.
    /// <br />
    ...
    public class ShowEnvironmentRequest : KineticaData
    {
        ...
        public struct Options
        {
            ...
            /// </list>
            /// The default value is <see
            /// cref="ShowEnvironmentRequest.Options.FALSE">FALSE</see>.</summary>
    ...
    public class ShowEnvironmentResponse : KineticaData
    {
        ...
        /// environments in <member name="environment_names" />.  </summary>
