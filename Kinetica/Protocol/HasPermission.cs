...
public class HasPermissionRequest : KineticaData
{
    ...
    /// <summary>Name of the user for which the permission is being checked.
    /// </summary>
    ...
    /// <summary>Constructs a HasPermissionRequest object with the specified
    /// parameters.</summary>
    ///
    /// <param name="principal">Name of the user for which the permission is
