...
public class GetRecordsRequest : KineticaData
{
    ...
    /// <summary>Constructs a GetRecordsRequest object with default parameters.
    /// </summary>
...
public class RawGetRecordsResponse : KineticaData
{
    ...
    /// was 'binary', then this list contains the binary encoded records
    /// retrieved from the table, otherwise not populated.</summary>
    public IList<byte[]> records_binary { get; set; } = new List<byte[]>();

    /// <summary>If the <see cref="GetRecordsRequest.encoding">encoding</see>
    /// was 'json', then this list contains the JSON encoded records retrieved
    /// from the table.</summary>
    /// <remarks><para>If the <see
    /// cref="GetRecordsRequest.encoding">encoding</see> was 'geojson' this
    /// list contains a single entry consisting of a GeoJSON FeatureCollection
    /// containing a feature per record. Otherwise not populated.</para>
    /// </remarks>
