...
public class AdminRemoveRanksRequest : KineticaData
{
    ...
    /// <summary>Each array value designates one or more ranks to remove from
    /// the cluster.</summary>
    /// <remarks><para>Values can be formatted as 'rankN' for a specific rank,
    /// 'hostN' (from the gpudb.conf file) to remove all ranks on that host, or
    ...
    ///
    /// <param name="ranks">Each array value designates one or more ranks to
    /// remove from the cluster. Values can be formatted as 'rankN' for a
    /// specific rank, 'hostN' (from the gpudb.conf file) to remove all ranks
...
public class AdminRemoveRanksResponse : KineticaData
{
    ...
    /// </summary>
    /// <remarks><para>This array will be empty if the operation fails.</para>
    /// </remarks>
