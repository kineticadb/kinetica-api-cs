...
public class AggregateStatisticsRequest : KineticaData
{
    ...
    public struct Stats
    {
        /// <summary>Number of objects (independent of the given column(s)).
        /// </summary>
        ...
        /// given value in the column(s) (if the given value is the median of
    ...
    /// <summary>Name of the table on which the statistics operation will be
    /// performed, in [schema_name.]table_name format, using standard <a
    /// href="../../../concepts/tables/#table-name-resolution"
    /// target="_top">name resolution rules</a>.</summary>
    public string table_name { get; set; }

    /// <summary>Name of the primary column for which the statistics are to be
    /// calculated.</summary>
    ...
    ///         median of the column(s), percentile_rank(&lt;median&gt;) will
    ///         return approximately 50.0).</description>
    ///     </item>
    /// </list></remarks>
    ...
    /// <summary>Constructs an AggregateStatisticsRequest object with default
    /// parameters.</summary>
    ...
    ///         <description>A list of comma separated column names over which
    ///         statistics can be accumulated along with the primary column.
    ///         All columns listed and <paramref name="column_name" /> must be
    ///         of the same type.  Must not include the column specified in
    ///         <paramref name="column_name" /> and no column can be listed
    ///         twice.</description>
    ///     </item>
    ///     <item>
    ///         <term><see
