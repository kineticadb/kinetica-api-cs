...
public class FilterByTableRequest : KineticaData
{
    ...
    /// <summary>Constructs a FilterByTableRequest object with the specified
    /// parameters.</summary>
    ///
    /// <param name="table_name">Name of the table whose data will be filtered,
    ...
    /// <param name="column_name">Name of the column by whose value the data
    /// will be filtered from the table designated by <paramref
    /// name="table_name" />.</param>
    /// <param name="source_table_name">Name of the table whose data will be
    /// compared against in the table called <paramref name="table_name" />, in
    /// [schema_name.]table_name format, using standard <a
    /// href="../../../concepts/tables/#table-name-resolution"
    /// target="_top">name resolution rules</a>.  Must be an existing table.
    /// </param>
    /// <param name="source_table_column_name">Name of the column in the
    /// <paramref name="source_table_name" /> whose values will be used as the
    /// filter for table <paramref name="table_name" />. Must be a geospatial
    /// geometry column if in 'spatial' mode; otherwise, Must match the type of
    /// the <paramref name="column_name" />.</param>
...
public class FilterByTableResponse : KineticaData
{
    ...
    /// cref="FilterByTableRequest.table_name">table_name</see> that have <see
    /// cref="FilterByTableRequest.column_name">column_name</see> values
    /// matching <see
