...
/// cref="FilterByRadiusRequest.view_name" /> is passed in as part of the
/// request.</para>
/// <para>For track data, all track points that lie within the circle plus one
/// point on either side of the circle (if the track goes beyond the circle)
/// will be included in the result.</para></remarks>
public class FilterByRadiusRequest : KineticaData
{
    /// <summary>A set of string constants for the parameter <see
    /// cref="FilterByRadiusRequest.options" />.</summary>
    /// <remarks><para>Optional parameters.</para></remarks>
    public struct Options
    {
        /// <summary>If <see
        /// cref="FilterByRadiusRequest.Options.TRUE">TRUE</see>, a unique
        ...
        /// cref="FilterByRadiusRequest.Options.FALSE">FALSE</see>.</para>
        /// </remarks>
    ...
    /// <summary>Name of the table on which the filter by radius operation will
    ...
    /// <remarks><para>Must be within [-90.0, 90.0]. The minimum allowed value
    /// is -90. The maximum allowed value is 90.</para></remarks>
    public double y_center { get; set; }

    /// <summary>The radius of the circle within which the search will be
    /// performed.</summary>
    /// <remarks><para>Must be a non-zero positive value. It is in meters; so,
    /// for example, a value of '42000' means 42 km. The minimum allowed value
    /// is 0. The maximum allowed value is MAX_INT.</para></remarks>
    ...
    ///         cref="FilterByRadiusRequest.view_name" />. This is always
    ...
    /// <summary>Constructs a FilterByRadiusRequest object with the specified
    /// parameters.</summary>
    ///
    /// <param name="table_name">Name of the table on which the filter by
    /// radius operation will be performed, in [schema_name.]table_name format,
    /// using standard <a
    /// href="../../../concepts/tables/#table-name-resolution"
    ...
    /// <param name="x_center">Value of the longitude of the center. Must be
    /// within [-180.0, 180.0]. The minimum allowed value is -180. The maximum
    /// allowed value is 180.</param>
    ...
    /// <param name="radius">The radius of the circle within which the search
    /// will be performed. Must be a non-zero positive value. It is in meters;
    /// so, for example, a value of '42000' means 42 km. The minimum allowed
    /// value is 0. The maximum allowed value is MAX_INT.</param>
...
{
    /// <summary>A set of string constants for the parameter <see
    /// cref="FilterByRadiusResponse.info" />.</summary>
