...
public class GrantPermissionRequest : KineticaData
{
    ...
    {
        /// <summary>Apply table security to these columns, comma-separated.
        /// </summary>
    ...
    /// <summary>Constructs a GrantPermissionRequest object with the specified
    /// parameters.</summary>
    ///
    ...
    /// <param name="_object">Name of object permission is being granted to.
...
public class GrantPermissionResponse : KineticaData
{
    ...
    /// <summary>Value of <see
    /// cref="GrantPermissionRequest.object_type">object_type</see>.</summary>
    public string object_type { get; set; }

    /// <summary>Value of <see
    /// cref="GrantPermissionRequest.permission">permission</see>.</summary>
    public string permission { get; set; }
