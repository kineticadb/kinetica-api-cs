...
public class RevokePermissionRequest : KineticaData
{
    ...
    {
        /// <summary>Full read/write and administrative access on the object.
        /// </summary>
        ...
        /// <summary>Monitor logs and statistics.</summary>
    ...
    {
        /// <summary>Revoke table security from these columns, comma-separated.
        /// </summary>
    ...
    /// revoked.</summary>
    /// <remarks><para> Must be an existing user or role. The default value is
    /// ''.</para></remarks>
    public string principal { get; set; } = "";

    /// <summary>Name of object permission is being revoked from.</summary>
    /// <remarks><para> It is recommended to use a fully-qualified name when
    ...
    /// <summary>Constructs a RevokePermissionRequest object with the specified
    /// parameters.</summary>
    ///
    ...
    /// <param name="_object">Name of object permission is being revoked from.
    /// It is recommended to use a fully-qualified name when possible.</param>
...
public class RevokePermissionResponse : KineticaData
{
    ...
    /// <summary>Value of <see
    /// cref="RevokePermissionRequest.object_type">object_type</see>.</summary>
    public string object_type { get; set; }

    /// <summary>Value of <see
    /// cref="RevokePermissionRequest.permission">permission</see>.</summary>
    public string permission { get; set; }
