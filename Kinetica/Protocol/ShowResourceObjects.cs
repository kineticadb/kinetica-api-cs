...
/// return results from actively used objects (default) or it can be used to
/// query the status of the objects of a given list of tables.
/// Returns detailed information about the requested resource objects.</para>
/// </remarks>
public class ShowResourceObjectsRequest : KineticaData
{
    ...
    {
        /// <summary>Comma-separated list of tiers to query, leave blank for
        /// all tiers.</summary>
        public const string TIERS = "tiers";

        /// <summary>An expression to filter the returned objects.</summary>
        /// <remarks><para>Expression is limited to the following operators:
        /// =,!=,&lt;,&lt;=,&gt;,&gt;=,+,-,*,AND,OR,LIKE. For details see <a
        /// href="../../../concepts/expressions/"
        /// target="_top">Expressions</a>. To use a more complex expression,
        /// query the ki_catalog.ki_tiered_objects table directly.</para>
        /// </remarks>
        ...
        /// results allowed by the server should be returned.</summary>
        ...
        /// <summary>Comma-separated list of tables to restrict the results to.
        /// </summary>
    ...
    /// <summary>Constructs a ShowResourceObjectsRequest object with default
    /// parameters.</summary>
