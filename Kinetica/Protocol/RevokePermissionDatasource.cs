...
public class RevokePermissionDatasourceRequest : KineticaData
{
    ...
    /// revoked.</summary>
    /// <remarks><para>Must be an existing data source, or an empty string to
    /// revoke permission from all data sources.</para></remarks>
    ...
    /// <summary>Constructs a RevokePermissionDatasourceRequest object with the
