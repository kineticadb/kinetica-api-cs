...
public class DropEnvironmentRequest : KineticaData
{
    ...
    /// <summary>Constructs a DropEnvironmentRequest object with the specified
    /// parameters.</summary>
    ///
    /// <param name="environment_name">Name of the environment to be dropped.
    /// Must be an existing environment.</param>
