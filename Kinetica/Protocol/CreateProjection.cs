...
/// target="_top">GEODIST(-77.11, 38.88, -71.06, 42.36)</a>).</para></remarks>
public class CreateProjectionRequest : KineticaData
{
    ...
    public struct Options
    {
        ...
        /// to be applied to the source table prior to the projection.
        /// </summary>
        ...
        /// for paging through the results).</summary>
        ...
        /// a chunk to be used for this projection.</summary>
        ...
        /// partitioning scheme from the source table.</summary>
        /// <remarks><para>Supported values:</para>
        /// <list type="bullet">
        ///     <item>
        ///         <term><see cref="Options.TRUE">TRUE</see></term>
        ...
        /// <summary>If set, window functions which require a reshard will be
        /// computed separately and joined back together, if the width of the
        ...
        /// <summary>If the projection is greater than this width (in bytes),
        /// then window functions which require a reshard will be computed
    ...
    /// single-row virtual table, where columns specified should be constants
    /// or constant expressions.</para></remarks>
    ...
    /// <summary>Constructs a CreateProjectionRequest object with the specified
    /// parameters.</summary>
    ///
    /// <param name="table_name">Name of the existing table on which the
    /// projection is to be applied, in [schema_name.]table_name format, using
    ...
    /// <param name="projection_name">Name of the projection to be created, in
    /// [schema_name.]table_name format, using standard <a
    /// href="../../../concepts/tables/#table-name-resolution"
    /// target="_top">name resolution rules</a> and meeting <a
    /// href="../../../concepts/tables/#table-naming-criteria"
