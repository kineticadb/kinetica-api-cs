...
public class FilterByBoxRequest : KineticaData
{
    ...
    /// <summary>Name of the column on which to perform the bounding box query.
    /// </summary>
    ...
    /// <param name="x_column_name">Name of the column on which to perform the
    /// bounding box query. Must be a valid numeric column.</param>
    ...
    /// Must be greater than or equal to <paramref name="min_x" />.</param>
    /// <param name="y_column_name">Name of a column on which to perform the
    /// bounding box query. Must be a valid numeric column.</param>
    /// <param name="min_y">Lower bound for <paramref name="y_column_name" />.
    /// Must be less than or equal to <paramref name="max_y" />.</param>
    /// <param name="max_y">Upper bound for <paramref name="y_column_name" />.
    /// Must be greater than or equal to <paramref name="min_y" />.</param>
