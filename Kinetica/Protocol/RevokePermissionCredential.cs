...
/// target="_top">credential-level permission</a> from a user or role.</para>
/// </remarks>
public class RevokePermissionCredentialRequest : KineticaData
{
    ...
    /// revoked.</summary>
    /// <remarks><para>Must be an existing credential, or an empty string to
    /// revoke access on all credentials.</para></remarks>
    ...
    /// <summary>Constructs a RevokePermissionCredentialRequest object with the
    ...
    /// permission will be revoked. Must be an existing credential, or an empty
    /// string to revoke access on all credentials.</param>
