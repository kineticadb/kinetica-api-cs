...
public class LockTableRequest : KineticaData
{
    ...
    /// <summary>Name of the table to be locked, in [schema_name.]table_name
    /// format, using standard <a
    /// href="../../../concepts/tables/#table-name-resolution"
    /// target="_top">name resolution rules</a>.</summary>
    /// <remarks><para> It must be a currently existing table or view.</para>
    /// </remarks>
    ...
    /// <summary>Constructs a LockTableRequest object with default parameters.
    /// </summary>
