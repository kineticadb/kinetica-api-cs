...
/// intersect (or go close to each other within the specified ranges). The user
/// also has the flexibility of using different metrics for the spatial
/// distance calculation: Euclidean (flat geometry) or Great Circle (spherical
/// geometry to approximate the Earth's surface distances). The filtered points
/// are stored in a newly created result set. The return value of the function
/// is the number of points in the resultant set (view).</para>
/// <para>This operation is synchronous, meaning that a response will not be
/// returned until all the objects are fully available.</para></remarks>
public class FilterBySeriesRequest : KineticaData
{
    ...
    /// <summary>Name of the table on which the filter by track operation will
    ...
    /// <summary>The ID of the track which will act as the filtering points.
    /// </summary>
    /// <remarks><para>Must be an existing track within the given table.</para>
    /// </remarks>
    public string track_id { get; set; }

    /// <summary>Up to one track ID to intersect with the "filter" track.
    /// </summary>
    /// <remarks><para>If any provided, it must be an valid track ID within the
    /// given set.</para></remarks>
    ...
    ///         point's geospatial coordinates. The value is interpreted in
    ///         meters. Required parameter. The minimum allowed value is '0'.
    ///         </description>
    ///     </item>
    ///     <item>
    ...
    ///         interpreted in seconds. Required parameter. The minimum allowed
    ...
    /// <summary>Constructs a FilterBySeriesRequest object with the specified
    /// parameters.</summary>
    ///
    /// <param name="table_name">Name of the table on which the filter by track
    ...
    /// </param>
    /// <param name="target_track_ids">Up to one track ID to intersect with the
    /// "filter" track. If any provided, it must be an valid track ID within
    /// the given set.</param>
