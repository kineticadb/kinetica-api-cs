...
public class CreateCredentialRequest : KineticaData
{
    ...
    /// cannot begin with a digit. Must not match an existing credential name.
    /// </para></remarks>
    ...
    /// <summary>Constructs a CreateCredentialRequest object with the specified
    /// parameters.</summary>
    ///
    /// <param name="credential_name">Name of the credential to be created.
    /// Must contain only letters, digits, and underscores, and cannot begin
    /// with a digit. Must not match an existing credential name.</param>
    ...
    /// <param name="secret">Password of the credential to be created.</param>
