...
/// of a given binning-column.  The statistics that may be requested are mean,
/// stdv (standard deviation), variance, skew, kurtosis, sum, min, max, first,
...
public class AggregateStatisticsByRangeRequest : KineticaData
{
    ...
    public struct Options
    {
        ...
        /// statistics can be accumulated along with the primary value_column.
        /// </summary>
        public const string ADDITIONAL_COLUMN_NAMES = "additional_column_names";

        /// <summary>A list of comma separated binning-column values.</summary>
    ...
    /// will be performed, in [schema_name.]table_name format, using standard
    /// <a href="../../../concepts/tables/#table-name-resolution"
    /// target="_top">name resolution rules</a>.</summary>
    public string table_name { get; set; }

    /// <summary>For a non-empty expression statistics are calculated for those
    /// records for which the expression is true.</summary>
    /// <remarks><para>The default value is ''.</para></remarks>
    public string select_expression { get; set; } = "";

    /// <summary>Name of the binning-column used to divide the set samples into
    /// bins.</summary>
    ...
    /// <remarks><para>Available statistics: mean, stdv (standard deviation),
    /// variance, skew, kurtosis, sum.</para></remarks>
    ...
    /// <remarks><para>Set members fall into bin i if the binning-column falls
    ...
    /// <summary>Constructs an AggregateStatisticsByRangeRequest object with
    ...
    /// <param name="select_expression">For a non-empty expression statistics
    /// are calculated for those records for which the expression is true. The
    /// default value is ''.</param>
    /// <param name="column_name">Name of the binning-column used to divide the
    /// set samples into bins.</param>
    /// <param name="value_column_name">Name of the value-column for which
    /// statistics are to be computed.</param>
    /// <param name="stats">A string of comma separated list of the statistics
    /// to calculate, e.g. 'sum,mean'. Available statistics: mean, stdv
    /// (standard deviation), variance, skew, kurtosis, sum.</param>
