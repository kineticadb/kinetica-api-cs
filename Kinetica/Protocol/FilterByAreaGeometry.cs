...
namespace kinetica
{
    ...
    /// table intersect a named area of interest (NAI/polygon). The operation
    /// is synchronous, meaning that a response will not be returned until all
    /// the matching objects are fully available. The response payload provides
    /// the count of the resulting set. A new resultant set (view) which
    /// satisfies the input NAI restriction specification is created with the
    /// name <see cref="view_name" /> passed in as part of the input.</para>
    /// </remarks>
