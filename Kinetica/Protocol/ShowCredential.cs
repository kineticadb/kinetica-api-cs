...
public class ShowCredentialRequest : KineticaData
{
    ...
    /// </summary>
    /// <remarks><para>The name must refer to a currently existing credential.
    /// If '*' is specified, information about all credentials will be
    ...
    /// <summary>Constructs a ShowCredentialRequest object with the specified
    /// parameters.</summary>
    ///
    ...
    /// credential. If '*' is specified, information about all credentials will
    /// be returned.</param>
...
public class ShowCredentialResponse : KineticaData
{
    ...
    /// <summary>Additional information about the respective credential in <see
    /// cref="ShowCredentialResponse.credential_names" />.</summary>
