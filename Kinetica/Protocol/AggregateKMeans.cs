...
/// minimized.  The k-means algorithm however does not necessarily produce such
/// an ideal cluster.   It begins with a randomly selected set of k points and
/// then refines the location of the points iteratively and settles to a local
/// minimum.  Various parameters and options are provided to control the
/// heuristic search.</para>
...
public class AggregateKMeansRequest : KineticaData
{
    ...
    {
        /// <summary>When set to 1 each of the columns is first normalized by
        /// its stdv - default is not to whiten.</summary>
        public const string WHITEN = "whiten";

        /// <summary>Number of times to try to hit the tolerance limit before
        /// giving up - default is 10.</summary>
        ...
        /// <remarks><para> If this option is specified, the results are not
    ...
    /// points will have n dimensions corresponding to the n columns.</para>
    /// </remarks>
    public IList<string> column_names { get; set; } = new List<string>();

    /// <summary>The number of mean points to be determined by the algorithm.
    /// </summary>
    public int k { get; set; }

    /// <summary>Stop iterating when the distances between successive points is
    /// less than the given tolerance.</summary>
    ...
    /// <summary>Constructs an AggregateKMeansRequest object with the specified
    /// parameters.</summary>
    ///
    ...
    /// <param name="column_names">List of column names on which the operation
    /// would be performed. If n columns are provided then each of the k result
    /// points will have n dimensions corresponding to the n columns.</param>
...
public class AggregateKMeansResponse : KineticaData
{
    ...
    /// <summary>The root mean squared distance of the elements in the cluster
    /// for each of the k-means values.</summary>
    public IList<double> rms_dists { get; set; } = new List<double>();

    /// <summary>The total count of all the clusters - will be the size of the
    /// input table.</summary>
    public long count { get; set; }

    /// <summary>The sum of all the rms_dists - the value the k-means algorithm
    /// is attempting to minimize.</summary>
    public double rms_dist { get; set; }

    /// <summary>The distance between the last two iterations of the algorithm
    /// before it quit.</summary>
    public double tolerance { get; set; }
