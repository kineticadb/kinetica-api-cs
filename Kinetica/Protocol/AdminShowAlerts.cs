...
public class AdminShowAlertsRequest : KineticaData
{
    ...
    /// <summary>Constructs an AdminShowAlertsRequest object with the specified
    /// parameters.</summary>
    ///
    /// <param name="num_alerts">Number of most recent alerts to request. The
    /// response will include up to <paramref name="num_alerts" /> depending on
    /// how many alerts there are in the system. A value of 0 returns all
    /// stored alerts.</param>
