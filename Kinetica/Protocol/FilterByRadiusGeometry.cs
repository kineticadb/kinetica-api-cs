...
/// NAI). The operation is synchronous, meaning that a response will not be
...
public class FilterByRadiusGeometryRequest : KineticaData
{
    ...
    public struct Options
    {
        ...
        /// cref="FilterByRadiusGeometryRequest.Options" /> options.</summary>
    ...
    /// <summary>Constructs a FilterByRadiusGeometryRequest object with default
    /// parameters.</summary>
