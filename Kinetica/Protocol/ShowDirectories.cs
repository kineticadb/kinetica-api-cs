...
public class ShowDirectoriesRequest : KineticaData
{
    ...
    /// <remarks><para>If empty, shows all directories. The default value is
    /// ''.</para></remarks>
    ...
    /// <summary>Constructs a ShowDirectoriesRequest object with the specified
    /// parameters.</summary>
    ///
    /// <param name="directory_name">The KiFS directory name to show. If empty,
    /// shows all directories. The default value is ''.</param>
