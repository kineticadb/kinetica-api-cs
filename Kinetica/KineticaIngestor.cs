...
{
    /// <summary>The exception thrown when a batch of records fails to insert.</summary>
    [Serializable]
    public class InsertException : KineticaException
    {
        /// <summary>The worker URL the failed batch was being sent to, if known.</summary>
        public Uri url { get; private set; }
        /// <summary>The records that were not successfully inserted.</summary>
        public IList<T> records { get; private set; }

        /// <summary>Initializes a new insert exception with the given message.</summary>
    ...
    // =========================
    /// <summary>The Kinetica client used to insert records.</summary>
    public Kinetica kineticaDB { get; }
    /// <summary>The name of the table records are inserted into.</summary>
    public string table_name { get; }
    /// <summary>The number of records buffered before a batch is flushed to the server.</summary>
    public int batch_size { get; }
    /// <summary>The insert options applied to each batch.</summary>
    public IDictionary<string, string> options { get; }
    //public IReadOnlyDictionary<string, string> options { get; }
    /// <summary>The running count of records inserted so far.</summary>
    public Int64 count_inserted;
    /// <summary>The running count of records that updated existing records (on primary-key collision).</summary>
