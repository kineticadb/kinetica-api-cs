...
{
    /// <summary>Initializes a new record conforming to the given Avro schema.</summary>
    /// <param name="schema">The Avro record schema describing the record's columns.</param>
