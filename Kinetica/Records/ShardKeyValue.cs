...
public readonly struct ShardKeyValue : IEquatable<ShardKeyValue>
{
    ...
    /// <summary>Determines whether two <see cref="ShardKeyValue"/> instances are equal.</summary>
    public static bool operator ==(ShardKeyValue left, ShardKeyValue right) => left.Equals(right);
    /// <summary>Determines whether two <see cref="ShardKeyValue"/> instances are not equal.</summary>
    public static bool operator !=(ShardKeyValue left, ShardKeyValue right) => !left.Equals(right);
