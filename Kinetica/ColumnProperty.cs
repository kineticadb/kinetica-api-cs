...
public struct ColumnProperty
{
    ...
    /// will be provided in milliseconds since the Unix epoch: 00:00:00 Jan 1
    /// 1970.  Dates represented by a timestamp must fall between the year 1000
    /// and the year 2900.</para></remarks>
    public const string TIMESTAMP = "timestamp";

    /// <summary>Valid only for 'string' columns.</summary>
    /// <remarks><para> It represents an unsigned long integer data type. The
    /// string can only be interpreted as an unsigned long data type with
    ...
    /// There can be up to 15 digits before the decimal point and up to four
    /// digits in the fractional part.  The value can be positive or negative
    /// (indicated by a minus sign at the beginning).  This property is
    /// mutually exclusive with the <see cref="TEXT_SEARCH" /> property.</para>
    /// </remarks>
    public const string DECIMAL = "decimal";

    /// <summary>Valid only for 'string' columns.</summary>
    /// <remarks><para> Indicates that this field represents a date and will be
    /// provided in the format 'YYYY-MM-DD'.  The allowable range is 1000-01-01
    /// through 2900-01-01.  This property is mutually exclusive with the <see
    /// cref="TEXT_SEARCH" /> property.</para></remarks>
    public const string DATE = "date";

    /// <summary>Valid only for 'string' columns.</summary>
    /// <remarks><para> Indicates that this field represents a time-of-day and
    /// will be provided in the format 'HH:MM:SS.mmm'.  The allowable range is
    /// 00:00:00.000 through 23:59:59.999.  This property is mutually exclusive
    /// with the <see cref="TEXT_SEARCH" /> property.</para></remarks>
    ...
    /// <summary>This property provides optimized memory, disk and query
    /// performance for string columns.</summary>
    /// <remarks><para>Strings with this property must be no longer than 128
    /// characters.</para></remarks>
    public const string CHAR128 = "char128";

    /// <summary>This property provides optimized memory, disk and query
    /// performance for string columns.</summary>
    /// <remarks><para>Strings with this property must be no longer than 256
    /// characters.</para></remarks>
    public const string CHAR256 = "char256";

    /// <summary>This property provides optimized memory and query performance
    /// for int columns.</summary>
    ...
    /// <summary>This property provides optimized memory and query performance
    /// for int columns.</summary>
    /// <remarks><para>Ints with this property must be between -128 and +127
    /// (inclusive)</para></remarks>
    ...
    /// 192.168.1.1).</summary>
    /// <remarks><para>Strings with this property must be of the form: A.B.C.D
    /// where A, B, C and D are in the range of 0-255.</para></remarks>
    public const string IPV4 = "ipv4";

    /// <summary>Valid only for 'string' columns.</summary>
    /// <remarks><para>Indicates that this field contains an array.  The value
    /// type and (optionally) the item count should be specified in
    /// parenthesis; e.g., 'array(int, 10)' for a 10-integer array.  Both
    /// 'array(int)' and 'array(int, -1)' will designate an unlimited-length
    ...
    /// <remarks><para>Indicates that this field contains a vector of floats.
    /// The length should be specified in parenthesis, e.g., 'vector(1000)'.
    /// </para></remarks>
    public const string VECTOR = "vector";

    /// <summary>Valid only for 'string' and 'bytes' columns.</summary>
    /// <remarks><para>Indicates that this field contains geospatial geometry
    /// objects in Well-Known Text (WKT) or Well-Known Binary (WKB) format.
    /// </para></remarks>
    public const string WKT = "wkt";

    /// <summary>This property indicates that this column will be part of (or
    /// the entire) <a href="../../../concepts/tables/#primary-keys"
    /// target="_top">primary key</a>.</summary>
    public const string PRIMARY_KEY = "primary_key";

    /// <summary>This property indicates that this column will be part of (or
    /// the entire) <a href="../../../concepts/tables/#soft-primary-keys"
    ...
    /// cref="CreateTypeRequest.type_definition">type_definition</see>.  For
    /// example, if a column is of type integer and is nullable, then the entry
    /// for the column in the Avro schema must be: ['int', 'null'].</para>
    /// <para>The C++, C#, Java, and Python APIs have built-in convenience for
    ...
    /// schema for the record.</para></remarks>
    ...
    /// for zstd level 7 compression.</summary>
    /// <remarks><para> This property is primarily used in order to save disk
    /// space.</para></remarks>
    ...
    /// string (charN), int, long or date columns. Dictionary encoding is best
    /// for columns where the cardinality (the number of unique values) is
    /// expected to be low. This property can save a large amount of memory.
    /// </para></remarks>
    ...
    /// <summary>For 'uuid' type, replace empty strings and invalid UUID values
    /// with randomly-generated UUIDs upon insert.</summary>
