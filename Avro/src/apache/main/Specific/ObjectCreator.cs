...
namespace Avro.Specific
{
    ...
    public sealed class ObjectCreator
    {
        ...
        private Type FindType(string name,bool throwError) 
        {
            ...
            name = name.Replace("IDictionary<string,", "System.Collections.Generic.IDictionary`2[System.String,");
            name = name.Replace("IDictionary<", "System.Collections.Generic.IDictionary`2[");
            name = name.Replace("<", "[");
            name = name.Replace(">", "]");
